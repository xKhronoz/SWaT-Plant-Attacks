...
PLC-1 which will determine the state of other PLCs.
...
'''
Global Variable to define script control type: start / stop / input
0 = stop plant
1 = start plant
...
def main():
    ...
    t = 5
    print("Waiting for {}s before closing connection...".format(t))
    time.sleep(5)
