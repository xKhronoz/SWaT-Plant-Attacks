...
from ppycomm.ab_comm.clx import Driver as ClxDriver
...
def main():
    ...
    """
    while(True):
        a=test_plc_read_val(PLC_IPS['plc2'], 'HMI_FIT201.pv')
        if(a[0]>H):
            test_plc_write(PLC_IPS['plc2'], 'HMI_FIT201.Sim', True , 'BOOL')
            test_plc_write(PLC_IPS['plc2'], 'HMI_FIT201.Sim_PV', 1.5, 'REAL')
