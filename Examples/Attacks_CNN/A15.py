...
def main():
    ...
    while(True):
        ...
        b=test_plc_read_val(PLC_IPS['plc2'], 'HMI_FIT201.pv')
        if(a[0]>H):
            test_plc_write(PLC_IPS['plc3'], 'HMI_LIT301.Sim', True , 'BOOL')
            test_plc_write(PLC_IPS['plc3'], 'HMI_LIT301.Sim_PV', a[0]-2, 'REAL')
            test_plc_write(PLC_IPS['plc2'], 'HMI_FIT201.Sim', True , 'BOOL')
            test_plc_write(PLC_IPS['plc2'], 'HMI_FIT201.Sim_PV', b[0]-0.2, 'REAL')            
